        ...
        <div class="col-md-3">
            <div class="admin-form">
                <div class="sid_bvijay mb10">
                    ...
                    <div>
                        <h4>Order</h4>
                        <input type="number" name="ordering" class="form-control" min="1" placeholder="Order"
                ...
                <div class="sid_bvijay mb10">
                    ...
                    <div class="hd_show_con">
                        <div id="xedit-demo">
                            @if ($data->banner)
                                <div class="mb10">
                                    <img src="{{ asset('uploads/banners/' . $data->banner) }}" alt="{{ $data->title }}"
