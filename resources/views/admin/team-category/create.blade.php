...
@endsection
@section('content')
    <form class="form-horizontal" role="form" action="{{ url('admin/teamcategory') }}" method="post"
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="bs-component">
                                <input type="text" id="cat_uri" name="uri" class="form-control" placeholder="" readonly/>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sid_bvijay mb10">
                    ...
                    <label class="field text">
                        <input type="number" id="inputStandard" name="ordering" class="form-control"
                            min="1" value="{{ $ordering }}" placeholder="Order" />
                    </label>
                </div>
