...
<div class="tray tray-center" style="">
    <div class="panel">
        <div class="panel-heading">
            <span class="panel-title"> Newsletters</span>
        </div>
                                ...
                                @foreach($data as $key => $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('newsletter.delete', $value->id) }}"
                                                onclick="return confirm('Are you sure you want to delete this Newsletter?')">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
