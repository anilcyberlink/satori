                            ...
                            <div id="xedit-demo">
                                ...
                                @if ($data->TTA1 != null)
                                    <span class="TTA1{{ $data->id }}">
                                        ...
                                        <a href="{{ asset('uploads/original/' . $data->TTA1) }}" target="_blank"><img
                                                src="{{ asset('uploads/original/' . $data->TTA1) }}" name="TTA1"
                                                width="150" /></a>
                                        <hr>
                                    </span>
                                @endif
                            ...
                            <div id="xedit-demo">
                                @if ($data->TTA2)
                                    <span class="TTA2{{ $data->id }}">
                                        ...
                                        <a href="{{ asset('uploads/original/' . $data->TTA2) }}" target="_blank"> <img
                                                src="{{ asset('/uploads/original/' . $data->TTA2) }}" name="TTA2"
                                                width="150" /></a>
                                        <hr>
                                    </span>
                                @endif
                            ...
                            <div id="xedit-demo">
                                @if ($data->Affiliated1)
                                    <span class="Affiliated1{{ $data->id }}">
                                        ...
                                        <a href="{{ asset('uploads/original/' . $data->Affiliated1) }}" target="_blank">
                                            <img src="{{ asset('/uploads/original/' . $data->Affiliated1) }}"
                                                name="Affiliated1" width="150" /></a>
                                        <hr>
                                    </span>
                                @endif
                            ...
                            <div id="xedit-demo">
                                @if ($data->Affiliated2)
                                    <span class="Affiliated2{{ $data->id }}">
                                        ...
                                        <a href="{{ asset('uploads/original/' . $data->Affiliated2) }}" target="_blank">
                                            <img src="{{ asset('/uploads/original/' . $data->Affiliated2) }}"
                                                name="Affiliated2" width="150" /></a>
                                        <hr>
                                    </span>
                                @endif
