    ...
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="bs-component">
                        <input type="file" class="form-control" id="contentEditor4" name="usa_address"
                            value="{{ $data->usa_address }}" />
                        @if (!empty($data->usa_address))
                            <img src="{{ asset('uploads/' . $data->usa_address) }}" alt="Image 1" width="150"
                                class="mb-2">
                        @endif
                    </div>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="bs-component">
                        <input type="file" id="inputStandard" name="usa_phone" class="form-control" placeholder=""
                            value="{{ $data->usa_phone }}" />
                        @if (!empty($data->usa_phone))
                            <img src="{{ asset('uploads/' . $data->usa_phone) }}" alt="Image 1" width="150"
                                class="mb-2">
                        @endif
                    </div>
                </div>
