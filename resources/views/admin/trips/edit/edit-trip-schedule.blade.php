                    ...
                    <div class="row" id="schedule-rec-{{ $loop->iteration }}">
                        <div class="col-lg-12">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" min="{{ date('Y-m-d') }}" name="schedule_ordering[]"
                            ...
                            <div class="col-md-1">
                                <button class="btn btn-danger delete-schedule" schedule-rowid="{{ $row->id }}" schedule-data-id="{{ $loop->iteration }}"><i class="glyphicon glyphicon-trash"></i>
                                </button>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="col-md-2">
                                ...
                                <input type="number" name="schedule_price[]" value="{{ $row->price }}"
                                    class="form-control" min="1" placeholder="" />
                            </div>
                            <div class="col-md-3">
                                <label>Price After Discount</label>
                                <input type="number" name="schedule_disprice[]" value="{{ $row->price }}"
                                    class="form-control" min="1" placeholder="" />
                            </div>
                            <div class="col-md-2">
                                <label>Total Seats</label>
                                <input type="number" name="schedule_seats[]" value="{{ $row->price }}"
                                    class="form-control" min="1" placeholder="" />
                            </div>
                        </div>
                        <div class="col-lg-12">
            ...
            <div id="row_schedule_additional">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-1">
                            <button class="btn btn-danger delete-schedule" schedule-data-id="0"><i
                    ...
                    <div class="col-lg-12">
                        <div class="col-md-2">
                            <label>Price (In USD $)</label>
                            <input type="number" name="schedule_price[]" class="form-control" min="1"  />
                        </div>
                        <div class="col-md-3">
                            <label>Price After Discount</label>
                            <input type="number" name="schedule_disprice[]" class="form-control" min="1"  />
                        </div>
                        <div class="col-md-2">
                            <label>Total Seats</label>
                            <input type="number" name="schedule_seats[]" class="form-control" min="1"  />
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <hr style="border: 0; border-top: 2px solid #000; margin: 20px 0;">
